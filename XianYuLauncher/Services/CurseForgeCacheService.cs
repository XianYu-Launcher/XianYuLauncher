...
/// </summary>
public class CurseForgeCacheService
{
        ...
        string category)
    {
        try
        {
            ...
            var cacheData = JsonConvert.DeserializeObject<CurseForgeCacheData>(json);
        ...
        int totalHits)
    {
        try
        {
            ...
            var cacheData = new CurseForgeCacheData
            {
        ...
        int totalHits)
    {
        try
        {
            ...
            {
                var json = await File.ReadAllTextAsync(cacheFilePath);
                cacheData = JsonConvert.DeserializeObject<CurseForgeCacheData>(json);
                if (cacheData != null)
                {
                ...
                {
                    cacheData = new CurseForgeCacheData
                    {
                        CacheTime = DateTime.Now,
                        ResourceType = resourceType,
                        Query = query,
